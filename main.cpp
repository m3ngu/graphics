...
void reshape(int width, int height){
	...
	glLoadIdentity();
	gluPerspective(90, w/(float)h, 1, 200);
	glViewport(0, 0, w, h);
}
...
void display() {
	...
	glBegin( GL_QUADS );
		glTexCoord2d(  0.0,  0.0); glVertex3d(-200.0,-100.0, -1.4);
		glTexCoord2d( 10.0,  0.0); glVertex3d( 200.0,-100.0, -1.4);
		glTexCoord2d( 10.0,  5.0); glVertex3d( 200.0, 100.0, -1.4);
		glTexCoord2d(  0.0,  5.0); glVertex3d(-200.0, 100.0, -1.4);
	glEnd();
	...
	glBegin( GL_QUADS );
		glTexCoord2d(0.0,0.0); glVertex3d(-200.0, 100.0, -1.4);
		glTexCoord2d(1.0,0.0); glVertex3d(-200.0, 100.0, 100);
		glTexCoord2d(1.0,1.0); glVertex3d( 200.0, 100.0, 100);
		glTexCoord2d(0.0,1.0); glVertex3d( 200.0, 100.0, -1.4);
	glEnd();
